...
require (
	git.mills.io/prologic/msgbus v0.1.21
	github.com/charmbracelet/bubbles v0.16.1
	github.com/keys-pub/keys v0.1.22
	github.com/matryer/is v1.4.1
	go.mills.io/salty v0.0.0-20220322161301-ce2b9f6573fa
	go.salty.im/saltyim v0.0.0-20230716004238-85ed56db8d8e
	go.sour.is/ev v0.0.4
	go.sour.is/pkg v0.0.4
	go.yarn.social/lextwt v0.0.0-20230423094258-531749640e75
)
